...
public class InternationalFlight extends JFrame
{
	...
	public String Iflight(String Class) {
		if(Class=="Economic") {
	System.out.println("book the ticket in:"+ " " + "Economic Class" );
	}
		if(Class=="Buisness")
		{
			System.out.println("book the ticket in:"+ " " + "Buisness Class" );
	...
	public int Checkage(int age) {
		...
		if(age<=12)
		{
			System.out.println("person is not allowed to interational tour");
		}
		return age;
	}
